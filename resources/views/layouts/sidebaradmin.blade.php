      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="header nav-small-cap"><i class="mdi mdi-drag-horizontal mr-5"></i>Data Master</li> 
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/forms_advanced.html"><i class="mdi mdi-toggle-switch-off"></i>Data Kecamatan</a></li>
                <li><a href="pages/forms_code_editor.html"><i class="mdi mdi-toggle-switch-off"></i>Data Desa</a></li>
                <li><a href="pages/forms_editor_markdown.html"><i class="mdi mdi-toggle-switch-off"></i>Data Tps</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/forms_advanced.html"><i class="mdi mdi-toggle-switch-off"></i>Grafik Kecamatan</a></li>
                <li><a href="pages/forms_code_editor.html"><i class="mdi mdi-toggle-switch-off"></i>Grafik Desa</a></li>
              </ul>
            </li>
