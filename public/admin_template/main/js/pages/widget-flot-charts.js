...
$(function () {
    ...
    var interactive_plot = $.plot('#interactive', [getRandomData()], {
	  ...
	  tooltip: true,
      lines : {
        fill : '#ef483e', //Converts the line chart to area chart
        color: '#ef483e'
      },
	  tooltipOpts: {
            content: "Visit: %y"
    ...
    var donutData = [
      { label: 'Jan-Apr', data: 85, color: '#ef483e' },
      { label: 'May-Aug', data: 68, color: '#05b085' },
      { label: 'Sep-Dec', data: 42, color: '#69cce0' }
    ]
